...
<p class="body-text">
    ...
    Municipality of Tampakan, Province of South Cotabato, belongs to an
    <strong>INDIGENT FAMILY</strong> in this barangay.
</p>

<p class="body-text">
    Based on our records and community assessment, the above-named individual
    and their family are classified under the low-income sector and are unable
    to afford basic necessities without government or social welfare assistance.
</p>
...
<div class="details-box">
    ...
    <div class="details-row">
        ...
        <span class="details-value">INDIGENT</span>
    </div>
    <div class="details-row">
...
<p class="body-text">
    ...
    for <strong>{{ strtoupper($req->purpose) }}</strong> purposes only and for
